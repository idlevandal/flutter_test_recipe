...
import 'package:flutter_test_recipe1/models/favorites.dart';
import 'package:flutter_test_recipe1/screens/favorites.dart';
...
void main() {
  group('Favorites Page Widget Tests', () {
    ...
    testWidgets('Testing Remove Button', (WidgetTester tester) async {
      await tester.pumpWidget(createFavoritesScreen());
      addItems();
      await tester.pumpAndSettle();
